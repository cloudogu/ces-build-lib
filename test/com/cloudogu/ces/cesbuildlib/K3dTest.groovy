...
class K3dTest extends GroovyTestCase {
    ...
    void testDeleteK3d() {
        ...
        // then
        assertThat(scriptMock.actualShStringArgs[9].trim()).contains("k3d registry delete citest-")
        assertThat(scriptMock.actualShStringArgs[10].trim()).contains("k3d cluster delete citest-")
    ...
    void testBuildAndPush() {
        ...
        // then
        assertThat(scriptMock.actualShStringArgs[9].trim()).isEqualTo("image pushed".toString())
        assertThat(scriptMock.actualShStringArgs.size()).isEqualTo(10)
    }
}
